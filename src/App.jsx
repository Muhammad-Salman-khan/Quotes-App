...
import img from "./assets/ChatGPT Image Jun 25, 2025, 02_23_32 PM.png";
function App() {
  ...
  const Pic = async () => {
    ...
    setPic(data.data.picture.large);
    setName(data.data.name.first);
  };
  const Advice = async () => {
  ...
  return (
    <>
      <div className="flex justify-center align-middle items-center min-h-screen bg-gradient-to-br from-gray-950 to-gray-900 ">
            ...
            <div className="p-8 relative z-10">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mb-4 transform group-hover:scale-105 transition-transform duration-300">
                  <p className="text-2xl capitalize font-extralight pb-2 font-mono bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent animate-pulse">
                    {name || "Hachiman"}
                  </p>
                  <p className="text-3xl capitalize font-bold bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent animate-pulse">
                    A Thought for You
                  </p>
                </div>

                <div className="space-y-1 max-w-sm">
                  <p className="text-gray-300 text-sm font-semibold leading-relaxed transform group-hover:text-gray-200 transition-colors duration-300"></p>
                  {Message}
                </div>
